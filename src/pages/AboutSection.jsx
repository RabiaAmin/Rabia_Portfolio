        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground sm:text-xs">
              I’m a frontend developer with expertise in Flutter and React,
              focused on building high-quality mobile and web applications. I
              deliver creative, efficient, and user-friendly solutions that help
              businesses grow and stand out.
            </p>
            <p className="text-muted-foreground sm:text-xs">
              I'm available for freelance work and also open to joining remote
              teams to contribute to innovative projects. I’m passionate about
              continuous learning and creating impactful digital experiences.
            </p>
